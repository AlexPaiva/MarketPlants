...
DROP TABLE IF EXISTS MarketPlants.Empresa;
DROP TABLE IF EXISTS MarketPlants.Utilizador;
DROP TABLE IF EXISTS MarketPlants.Tipo;
DROP SCHEMA IF EXISTS MarketPlants;
GO